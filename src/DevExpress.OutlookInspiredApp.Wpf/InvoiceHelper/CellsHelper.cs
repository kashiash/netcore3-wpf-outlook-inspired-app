...
namespace DevExpress.DevAV.Reports.Spreadsheet {
    public static class CellsHelper {
        ...
        public static bool IsOrderItemProductCell(Cell cell, DevExpress.Spreadsheet.Range orderItemRange) {
            return cell.LeftColumnIndex - orderItemRange.LeftColumnIndex == CellsHelper.FindCell(CellsKind.ProductDescription).Offset;
        }
        public static bool IsRemoveItemRange(Cell cell, DevExpress.Spreadsheet.Range orderItemsRange) {
        ...
        public static bool IsAddItemRange(Cell cell, DevExpress.Spreadsheet.Range orderItemsRange) {
            return IsSingleCellSelected(cell)
        ...
        public static CellValue GetOrderItemCellValue(CellsKind cell, DevExpress.Spreadsheet.Range orderItemRange, Worksheet invoice) {
